...
class _OfficialAuthenticationTabState extends State<OfficialAuthenticationTab> with AutoRefreshMixin {
    ...
    try {
      ...
      setState(() {
        if (response['success'] == true) {
          ...
          _filteredRequests = List.from(_verificationRequests); // Create immutable copy
        } else {
          _verificationRequests = [];
          _filteredRequests = [];
        }
  ...
  List<Map<String, dynamic>> _applyFilters(List<Map<String, dynamic>> requests, String statusFilter, String searchQuery) {
            ...
            children: [
              ...
              if (_selectedFilter != 'all' || _searchQuery.isNotEmpty)
                TextButton.icon(
                  ...
                  label: const Text('Clear', style: TextStyle(fontSize: 12, color: Colors.black)),
